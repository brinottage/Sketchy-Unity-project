...
public class CharacterController2D : MonoBehaviour
{
	...
	public bool isBlocked = false; //Bloquear personaje
...
//		Text platormTutorialTxt = GameObject.Find("platormTutorialTxt").GetComponent<Text>();
//		if (platormTutorialTxt) {
//			platormTutorialTxt.enabled = true;
//		}
        
		//GameObject.Find("platormTutorialTxt").GetComponent<Text>().text = String.Format("Level {0} completed!", numeroNivel);
	}
